/**
 * PostAdapterFactory
 * Registry Factory (OCP): Quản lý đăng ký và tra cứu Adapter của từng Platform cho Post Metrics.
 */
class PostAdapterFactory {
  constructor() {
  ...
  getAdapter(platform) {
    ...
    if (!adapter) {
      throw new Error(`No PostInsightAdapter registered for platform: '${platform}'`);
    }
    return adapter;
  }

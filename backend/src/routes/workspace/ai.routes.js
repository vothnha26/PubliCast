...
// requireFeature only checks subscription entitlement, not brand membership
// — every route below took brandId from the query/body with no ownership
// check at all, letting any authenticated user read/write another brand's
// AI settings and prompt history (#49).

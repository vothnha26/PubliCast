...
const smartLinkController = require('../../controllers/workspace/smart-link.controller.v2');
const autoListController = require('../../controllers/workspace/auto-list.controller.v2');
const hashtagController = require('../../controllers/workspace/hashtag.controller.v2');
const postingGoalController = require('../../controllers/workspace/posting-goal.controller.v2');
const streakController = require('../../controllers/workspace/streak.controller.v2');
const feedController = require('../../controllers/workspace/feed.controller.v2');
const calendarEventController = require('../../controllers/workspace/calendar-event.controller.v2');
const stockController = require('../../controllers/workspace/stock.controller.v2');

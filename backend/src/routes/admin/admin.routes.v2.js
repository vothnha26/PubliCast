...
const pricingController = require('../../controllers/admin/pricing.controller.v2');
const auditLogController = require('../../controllers/admin/audit-log.controller.v2');
const revenueController = require('../../controllers/admin/revenue.controller.v2');
const productController = require('../../controllers/admin/product.controller.v2');
const platformLimitController = require('../../controllers/admin/platform-limit.controller.v2');
const postingUsageMonitoringController = require('../../controllers/admin/posting-usage-monitoring.controller.v2');
const userController = require('../../controllers/admin/user.controller.v2');
const templateController = require('../../controllers/admin/template.controller.v2');
const feedController = require('../../controllers/admin/feed.controller.v2');

...
import { 
  ArrowLeft, BarChart2, Users, Image as ImageIcon, Globe, Search, 
...
export function HashtagAnalysisPage() {
  ...
  if (loading) {
    return (
      <div className="flex-1 flex items-center justify-center bg-[#F8F8F7] min-h-screen">
        <div className="bg-white rounded-2xl p-10 shadow-xl flex flex-col items-center gap-4 max-w-sm w-full border border-gray-150">
          <div className="w-10 h-10 border-4 border-t-transparent border-slate-900 rounded-full animate-spin" />
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-[#F8F8F7] overflow-hidden">
      
      {/* Header */}
      <div className="px-8 py-5 border-b border-gray-150 flex items-center justify-between bg-white shadow-xs">
        <div className="flex items-center gap-3">
          <button 
            onClick={() => navigate('/hashtags')}
            className="p-2 rounded-xl bg-white border border-gray-250 text-gray-500 hover:text-gray-800 hover:shadow-sm transition-all cursor-pointer mr-1"
          >
            <ArrowLeft size={16} />
          </button>

...
export function GettingStartedPage() {
  ...
  const handleFinishSetup = async () => {
    ...
    try {
      ...
      // In a real app, you might also create a Brand entity here
      // For now we just update user profile
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-[#F8F8F7] p-6 overflow-y-auto">
      <div style={{ background: "#FFF", borderRadius: 20, padding: "48px 60px", width: "100%", maxWidth: 640, border: "0.5px solid #E5E7EB", boxShadow: "0 4px 20px rgba(0,0,0,0.02)" }}>
        {/* Progress */}
        {screen !== "complete" && (
        ...
        {screen === "onboard3" && (
          <>
            ...
            <h3 style={{ fontSize: 24, fontWeight: 500, color: "#0A0A0A", textAlign: "center", marginBottom: 8 }}>Create your first Brand</h3>
            <p style={{ fontSize: 15, color: "#6B7280", textAlign: "center", marginBottom: 36 }}>Your brand will group all your social accounts together.</p>
